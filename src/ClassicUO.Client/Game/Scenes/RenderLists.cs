...
public class RenderLists
{
    ...
    public void AddGumpWithAtlas(Func<UltimaBatcher2D, bool> toRender) => _gumpSprites.Add(toRender);
    ...
    /// </summary>
    /// <param name="toRender"></param>
    public void AddGumpNoAtlas(Func<UltimaBatcher2D, bool> toRender) => _gumpTexts.Add(toRender);
